package com.test.rockpaperscissors.server.config;

import com.test.rockpaperscissors.server.controller.RockPaperScissorsWebSocketHandler;
import com.test.rockpaperscissors.server.service.GameService;
import com.test.rockpaperscissors.server.service.GameStateProcessor;
import com.test.rockpaperscissors.server.service.HumanAdaptedGameService;
...
import com.test.rockpaperscissors.server.service.ai.MarkovChainBasedAi;
import com.test.rockpaperscissors.server.service.ai.MarkovChainBasedPredictor;
import com.test.rockpaperscissors.server.service.ai.RandomAi;
import com.test.rockpaperscissors.server.service.ai.TransitionMatrixUpdater;
